...
- **⭐ USER-REQUESTED REMINDER (2026-06-16): add an animation for the cards** (e.g., subtle entrance/press animation on audition + listing cards — likely react-native-reanimated, which is already installed).
